...
public final class Constants{
    ...
    public static final class IntakeConstants{
        public static final int P_SHOOTER_vicSPX_1 = 5;
        public static final int P_SHOOTER_vicSPX_2 = 6;

        // shreyes added code kindly remove at later date
        public static final int P_SHOOTER_vicSPX_3 = 7;
        public static final int P_SHOOTER_vicSPX_4 = 8;
    }
